...
For the variable `AGE`, `YOJ`, `INCOME`, `CAR_AGE`, we'll use the PMM imputation from the `mice` package.
```{r, echo=FALSE}
# mice imputation
...
mice_imp = mice(input_training, m = 10, 
                method = method_vector)
summary(input_training$AGE)
mice_imp$imp$AGE
clean_insurance_training_data <- complete(mice_imp, 10)
